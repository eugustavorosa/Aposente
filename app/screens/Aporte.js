...
function Aporte({
  ...
  const [descrição, setDescrição] = useState("Aporte");
  ...
  const categories = [
    { label: "Aporte Mensal", value: 1, name: "cash" },
    { label: "Aporte Extra", value: 2, name: "cash-plus" },
  ];
        ...
        <Tela>
          <View style={styles.containerHead}>
            ...
            <AppPicker
              ...
              onPress={onPressPickerAporte}
            />
          </View>
          <AppText style={styles.tituloValor}>Valor do Aporte</AppText>
          <CurrencyInput
      ...
      <View style={styles.container}>
        <Tela>
          ...
          <View style={styles.button}>
            <OkButton backgroundColor={colors.primary} onPress={onPressDone} />
          </View>
        </Tela>
      </View>
    </>
